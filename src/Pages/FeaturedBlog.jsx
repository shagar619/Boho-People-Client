...
const FeaturedBlog = () => {
    ...
    return (
        ...
        <div className="pb-56 pt-36 mb-12 bg-blue-100">
            <h1 className="uppercase text-center text-4xl font-bold text-blue-800 underline mt-12">Featured Blogs</h1>

            <SectionTitle
            heading={'Top 10 Featured Blogs'}
            subHeading={'Explore the most engaging and comprehensive blogs, handpicked based on their depth and word count. These top 10 posts offer valuable insights, detailed discussions, and expert opinions to keep you informed and inspired. Dive into the best content curated just for you!'}></SectionTitle>
